...
namespace CourseLibrary.API.Controllers
{
    ...
    public class AuthorCollectionsController: ControllerBase
    {
            ...
            IEnumerable<AuthorForCreationDto> authorCollection)
        {
            ...
            var authoeIdsAsString = string.Join(", ", authorCollectionToReturn.Select(a => a.Id));

            return CreatedAtRoute("GetAuthorCollection", new { authorIds = authoeIdsAsString}, authorCollectionToReturn);
        }
